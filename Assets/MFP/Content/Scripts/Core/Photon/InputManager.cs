...
namespace DestroyIt
{
    ...
    public class InputManager : MonoBehaviour
    {
        ...
        {
            if (Camera.main != null)
                hud = Camera.main.GetComponent<HeadsUpDisplay>();
            else
            {
            ...
            firstPersonController = Camera.main.transform.parent;
                ...
                switch (SelectedWeapon)
                {
                    ...
                    case WeaponType.Nuke: // Nuclear Blast and Rolling Shockwave Damage
                        if (nukeTimer <= 0f)
                        {
                            ...
                            Tonemapping toneMapping = Camera.main.GetComponent<Tonemapping>();
