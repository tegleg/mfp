...
namespace DestroyIt
{
    ...
    public class Rocket : MonoBehaviour
    {
        ...
        private void EngineShutDown()
        {
            ...
            transform.FindChild("exhaust").gameObject.SetActive(false);
            outOfFuel = true;

            // turn off point light (no thrust means no light source)
            Transform pointLight = transform.FindChild("point light");
            if (pointLight != null)
        ...
        private void TurnOffSmokeTrail()
        {
            ...
            smokeTrailObj.GetComponent<ParticleSystem>().enableEmission = false;
